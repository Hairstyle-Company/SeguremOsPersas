export default class win extends Phaser.Scene {
  ...
  preload () {
    this.load.audio('clique', './assets/musicas/clique.mp3')
    this.load.audio('credito', './assets/musicas/credito.mp3')
    this.load.audio('erro', './assets/musicas/erro.mp3')
  }
